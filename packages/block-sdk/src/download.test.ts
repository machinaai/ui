...
describe('test block download utils', () => {
  it('isGitUrl', () => {
    ...
    expect(isGitUrl('https://github.com/machinaai/umi-blocks.git')).toEqual(true);
    expect(isGitUrl('https://github.com/machinaai/umi-blocks/tree/master/demo')).toEqual(true);
    expect(
  ...
  it('parseGitUrl', async () => {
    ...
    expect(await parseGitUrl('https://github.com/machinaai/umi-blocks/tree/master/demo', true)).toEqual(
      {
        repo: 'https://github.com/machinaai/umi-blocks.git',
        branch: 'master',
        path: '/demo',
    ...
    expect(
      await parseGitUrl(
        'https://github.com/machinaai/umi-blocks/tree/master/ant-design-pro/Analysis',
        true,
      ),
    ).toEqual({
      repo: 'https://github.com/machinaai/umi-blocks.git',
    ...
    expect(await parseGitUrl('https://github.com/machinaai/umi-blocks.git', true)).toEqual({
      repo: 'https://github.com/machinaai/umi-blocks.git',
      branch: 'master',
      path: '/',
      id: 'github.com/umijs/umi-blocks',
